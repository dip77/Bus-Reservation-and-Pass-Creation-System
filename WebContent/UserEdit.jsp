...
<body class="col-*-*">
	<%@include file="UserHeader.jsp"%>
		<form action="UserEditValidateServlet?id=${userBean.userId}"
			method="post">
			<br />
			<div class="col-*-*">
				<div class="container">
						...
						<div class="col-lg-8">
							...
							<div class="col-md-3">
								<input type="text" id="txtfirstName" name="txtfirstName"
									...
									value="${userBean.firstName}" /><font color="red"><b>${msgfirstName}</b>
								</font>
							</div>
							<div class="col-md-3">
								<input type="text" name="txtmiddleName" id="txtmiddleName"
									maxlength="15" placeholder="Enter Middle Name"
									class="form-control" value="${userBean.middleName}" /><font
									color="red"><b>${msgmiddlename}</b>
								</font>
							</div>
							<div class="col-md-3">
								<input type="text" name="txtlastName" id="txtlastName"
									placeholder="Enter last" maxlength="15" class="form-control"
									value="${userBean.lastName}" /><font color="red"><b>${msglastname}</b>
								</font>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-8">
							...
							<div class="col-md-9">
								...
								<input type="text" name="txtemail" id="txtemail" maxlength="30"
									...
									value="${userBean.email}" /><font color="red"><b>${msgemail}</b>
								</font>
							</div>
						</div>
						<br /> <br /> <br />
							...
							<div class="col-lg-8">
								...
								<div class="col-md-9">
									<input type="password" name="pwdpassword" id="txtpassword"
										...
										class="form-control" value="${userBean.password}"
							...
							<div class="col-lg-8">
								...
								<div class="col-md-9">
									...
									<input type="text" name="txtmobile" id="txtmobile"
										...
										class="form-control" value="${userBean.mobile}" /> <font
										color="red"><b>${msgmobile}</b>
									</font>
								</div>
							</div>
						</div>
