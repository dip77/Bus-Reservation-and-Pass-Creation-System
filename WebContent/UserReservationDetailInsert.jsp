...
<%@include file="UserHeader.jsp"%>
		...
		<form name="reservation" method="post">
			...
			<!-- --------------------------- submit button ----------------------------------------- -->
<div style="margin-left: 900px; position: absolute; margin-top: -410px;">
		<button style="font-size: 30px;" type="button" id="btnShowNew" class="fa fa-check gujju-btn gujju-blue">&emsp;Confirm</button>
			</div>
			...
			$(function() {
				...
				$('#btnShowNew').click(
						function() {
							...
							alert(str.join(','));
							document.reservation.action = "UserReseravationDetailInsertServlet?id=" + str;
